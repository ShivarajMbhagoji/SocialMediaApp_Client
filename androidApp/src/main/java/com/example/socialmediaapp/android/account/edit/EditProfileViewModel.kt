...
class EditProfileViewModel(
    ...
    private suspend fun uploadProfile(imageBytes: ByteArray?, profile: com.example.socialmediaapp.account.domain.model.Profile){
        delay(1000)
...
data class EditProfileUiState(
    ...
    val profile: com.example.socialmediaapp.account.domain.model.Profile? = null,
